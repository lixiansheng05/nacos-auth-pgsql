/*
 ...
 Source Host           : 192.168.2.23:5432
 Source Catalog        : naocs
 Source Schema         : nacos
...
-- ----------------------------
DROP SEQUENCE IF EXISTS "nacos"."config_tags_relation_id_seq";
CREATE SEQUENCE "nacos"."config_tags_relation_id_seq" 
INCREMENT 1
MINVALUE  1
MAXVALUE 9223372036854775807
START 1
...
-- ----------------------------
INSERT INTO "nacos"."his_config_info" VALUES (0, 1, 'tsinghuan-gateway-dev.yml', 'DEFAULT_GROUP', '', 'server:
  port: 9527

spring:
  application:
    name: tsinghuan-gateway
  cloud:
    nacos:
      discovery:
...
', '4e12c7993ff3d71f57eb3bbe61bc8db4', '2010-05-05 00:00:00', '2023-08-28 18:12:52.192', NULL, '192.168.3.1', 'I         ', '', '');
INSERT INTO "nacos"."his_config_info" VALUES (1, 2, 'tsinghuan-gateway-dev.yml', 'DEFAULT_GROUP', '', 'server:
  port: 9527
    ...
    gateway:
      ...
      routes:
        - id: payment_routh #payment_route    #路由的ID，没有固定规则但要求唯一，建议配合服务名
          ...
          predicates:
            - Path=/payment/get/**         # 断言，路径相匹配的进行路由
', '4e12c7993ff3d71f57eb3bbe61bc8db4', '2010-05-05 00:00:00', '2023-08-28 18:13:37.394', 'nacos', '192.168.3.1', 'U         ', '', '');
INSERT INTO "nacos"."his_config_info" VALUES (1, 3, 'tsinghuan-gateway-dev.yml', 'DEFAULT_GROUP', '', 'server:
  port: 9526
    ...
    gateway:
      ...
      routes:
        - id: payment_routh #payment_route    #路由的ID，没有固定规则但要求唯一，建议配合服务名
          ...
          predicates:
            - Path=/payment/get/**         # 断言，路径相匹配的进行路由
', 'e194f238126171c9317fa09c90e95707', '2010-05-05 00:00:00', '2023-08-29 08:57:11.132', NULL, '192.168.3.1', 'D         ', '', '');
...
-- ----------------------------
INSERT INTO "nacos"."tenant_info" VALUES (2, '1', 'dev', 'dev', '开发环境', 'nacos', 1693465700420, 1693465700420);
INSERT INTO "nacos"."tenant_info" VALUES (3, '1', 'test', 'test', '测试环境', 'nacos', 1693465717001, 1693465717001);
INSERT INTO "nacos"."tenant_info" VALUES (4, '1', 'prod', 'prod', '生产环境', 'nacos', 1693465730377, 1693465730377);
...
-- Records of users
-- ----------------------------
INSERT INTO "nacos"."users" VALUES ('nacos', '$2a$10$EuWPZHzz32dJN7jexM34MOeYirDdFAZm2kuWj7VEOJhhZkDrxfvUu', 't');
...
SELECT setval('"nacos"."config_info_aggr_id_seq"', 2, false);
...
SELECT setval('"nacos"."config_info_beta_id_seq"', 2, false);
...
SELECT setval('"nacos"."config_info_id_seq"', 3, true);
...
SELECT setval('"nacos"."config_info_tag_id_seq"', 2, false);

-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
ALTER SEQUENCE "nacos"."config_tags_relation_id_seq"
OWNED BY "nacos"."config_tags_relation"."id";
SELECT setval('"nacos"."config_tags_relation_id_seq"', 2, false);
...
SELECT setval('"nacos"."config_tags_relation_nid_seq"', 2, false);
...
SELECT setval('"nacos"."group_capacity_id_seq"', 2, false);
...
SELECT setval('"nacos"."his_config_info_nid_seq"', 4, true);
...
SELECT setval('"nacos"."tenant_capacity_id_seq"', 2, false);
...
SELECT setval('"nacos"."tenant_info_id_seq"', 5, true);
